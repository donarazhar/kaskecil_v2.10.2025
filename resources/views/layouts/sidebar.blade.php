...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .pagi .page-item .page-link:hover, .pagi-wrap .page-item .page-link:hover { background: var(--gray-50); color: var(--blue); border-color: var(--gray-300); transform: translateY(-2px); box-shadow: 0 4px 6px rgba(0,0,0,0.04); }
        .pagi .page-item.active .page-link, .pagi-wrap .page-item.active .page-link { background: var(--blue); border-color: var(--blue); color: #fff; box-shadow: 0 4px 10px rgba(0,83,197,0.3); transform: translateY(-2px); }
