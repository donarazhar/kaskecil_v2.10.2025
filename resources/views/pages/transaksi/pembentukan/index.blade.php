...
<div class="modern-card">
    <div class="modern-card-header">
        <h6 class="modern-card-title">
            ...
            Data Pembentukan Kas Kecil
        </h6>
        @if (Auth::user()->level == 'admin')
        <button class="btn-modern btn-primary-modern" id="btnTambahPembentukan">
            ...
            <table class="table-modern">
                <thead>
                    <tr>
                        ...
                        <th style="width: 25%;">Perincian</th>
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="empty-state">
                                ...
                                <p>Silakan tambahkan data pembentukan kas kecil terlebih dahulu</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
            ...
            <div class="modal-body">
                <form action="{{ route('transaksi.store') }}" method="post" id="frmpembentukan">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="perincian" id="perincian" class="form-control" 
                            placeholder="Masukkan perincian transaksi"></textarea>
                    </div>
